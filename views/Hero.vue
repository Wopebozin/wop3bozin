      ...
      <h1 class="md:text-center max-w-[990px]">
        ...
        <span>
          <img
            src="../assets/WhimsyLine.svg"
            alt=""
            class="hidden md:flex relative md:-top-[18rem] xl:-top-[5.5rem] lg:-left-[3rem] xl:-left-[10rem]" />
          <img
            src="../assets/Star.svg"
            alt=""
      ...
      <p class="max-w-[572px]">
        ...
        <span
          ><img
            src="../assets/Star.svg"
            alt=""
            class="hidden md:flex relative float-right lg:-top-9 md:-top-5 md:-right-[5rem] lg:-right-[7rem] xl:-right-[19rem]"
        /></span>
      </p>
    </div>
