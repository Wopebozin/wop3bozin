  ...
  <section class="flex justify-center mb-20">
    <section class="p-4 max-w-[1440px]">
      ...
      <div class="text-left flex flex-col gap-5 lg:max-w-[60vw]">
        ...
        <p class="font-bold text-xl text-[#fd7965]">
        ...
        <ul class="gap-2 ml-5">
          <li>By email: support@wopebozin.com</li>
          <li>By visiting this page on our website: wopebozin.com</li>
        </ul>
      </div>
    </section>
  </section>
