  ...
  <section class="flex justify-center mb-20">
    <section class="p-4 max-w-[1440px]">
      ...
      <div class="text-left flex flex-col gap-5 lg:max-w-[60vw]">
        ...
        <p class="font-bold text-2xl text-[#fd7965]">Privacy Policy</p>
        ...
        <p class="font-bold text-xl text-[#fd7965]">1. Interpretation and Definitions</p>
        <p class="font-bold text-lg">Interpretation</p>
        The words of which the initial letter is capitalized have meanings
        defined under the following conditions. The following definitions shall
        have the same meaning regardless of whether they appear in singular or
        in plural.
        <p class="font-bold text-lg">Definitions</p>
        <p class="italic font-bold">For the purposes of this Privacy Policy:</p>
        ...
        <p class="font-bold text-xl text-[#fd7965]">2. Collecting and Using Your Personal Data</p>
<p class="font-bold text-lg">Types of Data Collected</p>
<b>Personal Data</b>
...
<ul class=" list-disc gap-2 ml-5"><li>Email address</li>
<li>Phone number</li>
<li>Usage Data</li></ul>
<b>Usage Data</b>
...
<p>While using Our Application, in order to provide features of Our Application, We may
collect, with Your prior permission:</p>
<ul class=" flex flex-col gap-2 list-disc ml-5"><li>Information from your Device's phone book (contacts list)</li>
<li>Pictures and other information from your Device's camera and photo library</li></ul>
...
settings.</p>
<p class="font-bold text-xl text-[#fd7965]">3. Use of Your Personal Data</p>
<p class=" italic font-bold">The Company may use Personal Data for the following purposes:</p>
<ul class=" flex flex-col gap-2 list-disc ml-5"><li><b>To provide and maintain our Service,</b> including to monitor the usage of our
Service.</li>
...
<li><b>For the performance of a contract:</b> the development, compliance and undertaking
...
<li><b>To contact You:</b> To contact You by email, telephone calls, SMS, or other equivalent
...
<li><b>To provide You with news,</b> special offers and general information about other
...
<li><b>For business transfers:</b> We may use Your information to evaluate or conduct a
...
<li><b>For other purposes:</b> We may use Your information for other purposes, such as data
...
and your experience.</li></ul>
<p class=" italic font-bold" >We may share Your personal information in the following situations:</p>
<ul class=" flex flex-col gap-2 list-disc ml-5"><li><b>With Service Providers:</b> We may share Your personal information with Service
...
<li><b>With Affiliates:</b> We may share Your information with Our affiliates, in which case we
...
<li><b>With other users:</b> when You share personal information or otherwise interact in the
public areas with other users, such information may be viewed by all users and may be
publicly distributed outside.</li>
<li><b>With Your consent:</b> We may disclose Your personal information for any other purpose
with Your consent.</li></ul>
<p class="font-bold text-xl text-[#fd7965]">4. Retention of Your Personal Data</p>
...
<p class="font-bold text-xl text-[#fd7965]">5. Transfer of Your Personal Data</p>
...
<p class="font-bold text-xl text-[#fd7965]">6. Delete Your Personal Data</p>
...
any personal information that You have provided to Us.</p>
...
<p class="font-bold text-xl text-[#fd7965]">7. Disclosure of Your Personal Data</p>
<p class="font-bold text-lg">Business Transactions</p>
...
<p class="font-bold text-lg">Law enforcement</p>
...
<p class="font-bold text-lg">Other legal requirements</p>
<p class=" italic font-bold">The Company may disclose Your Personal Data in the good faith belief that such action is
necessary to:</p>
<ul class=" flex flex-col gap-2 list-disc ml-5"><li>Comply with a legal obligation</li>
<li>Protect and defend the rights or property of the Company</li>
<li>Prevent or investigate possible wrongdoing in connection with the Service</li>
<li>Protect the personal safety of Users of the Service or the public</li>
<li>Protect against legal liability</li></ul>
<p class="font-bold text-xl text-[#fd7965]">8. Security of Your Personal Data</p>
...
<p class="font-bold text-xl text-[#fd7965]">9. Children's Privacy</p>
...
<p class="font-bold text-xl text-[#fd7965]">10. Links to Other Websites</p>
...
<p class="font-bold text-xl text-[#fd7965]">11. Changes to this Privacy Policy</p>
...
<p class="font-bold text-xl text-[#fd7965]">12. Contact Us</p>
<p>If you have any questions about this Privacy Policy, You can contact us:</p>
<ul class=" gap-2 ml-5"><li>By email: support@wopebozin.com</li>
<li>By visiting this page on our website: wopebozin.com</li></ul>
      </div>
    </section>
  </section>
