<template>
  <section class="p-4">
    ...
    <div class="text-left flex flex-col gap-5">
      ...
      <p>Welcome to Wopebozin!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Wopebozin LLC's Website, located at wopebozin.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Wopebozin if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of gh. Any use of the above terminology or
      ...
      <p>Cookies</p>
      <p>
        We employ the use of cookies. By accessing Wopebozin, you agreed to use
        cookies in agreement with the Wopebozin LLC's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        Wopebozin for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <div>
        <p>Republish material from Wopebozin</p>
        <p>Sell, rent or sub-license material from Wopebozin</p>
        <p>Reproduce, duplicate or copy material from Wopebozin</p>
        <p>Redistribute content from Wopebozin</p>
        <p>
      ...
      <p>
        ...
        Wopebozin LLC does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Wopebozin LLC,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Wopebozin LLC shall not be
      ...
      <p>
        Wopebozin LLC reserves the right to monitor all Comments and to remove
      ...
      <div>
        ...
        <p>
          You hereby grant Wopebozin LLC a non-exclusive license to use,
      ...
      <div>
        ...
        <p>
          ...
          the hyperlink compensates the absence of Wopebozin LLC; and (d) the
      ...
      <p>
        ...
        e-mail to Wopebozin LLC. Please include your name, your organization
      ...
      <div>
        ...
        <p>
          No use of Wopebozin LLC's logo or other artwork will be allowed for
