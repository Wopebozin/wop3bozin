    ...
    <section class="p-4 max-w-[1440px]">
      ...
      <div class="text-left flex flex-col gap-5 lg:max-w-[60vw]">
        ...
        <p>
          ...
          conditions. Do not continue to use Wopebozin if you do not agree to
        ...
        <p>
          ...
          accordance with and subject to, prevailing law of gh. Any use of the
        ...
        <ul class="flex flex-col gap-2 list-disc ml-5">
          ...
          <li>Redistribute content from Wopebozin</li>
          <li>
        ...
        <p>
          ...
          Wopebozin LLC does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Wopebozin LLC,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Wopebozin LLC
        ...
        <ul class="flex flex-col gap-2 list-disc ml-5">
          ...
          <li>
            ...
            visibility of the hyperlink compensates the absence of Wopebozin
        ...
        <p>
          ...
          sending an e-mail to Wopebozin LLC. Please include your name, your
